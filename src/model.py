...
#pickle.dump(tfidf_embeddings_matrix, open('/Users/anastasiakaravdina/code/podcasts-recommender-system/models/tfidf_embeddings_matrix.pkl', 'wb'))
scipy.sparse.save_npz('/Users/anastasiakaravdina/code/podcasts-recommender-system/models/tfidf_embeddings_matrix.npz', tfidf_embeddings_matrix)
pickle.dump(similarity_matrix, open('/Users/anastasiakaravdina/code/podcasts-recommender-system/models/similarity_matrix.pkl', 'wb'))
...
pickle.dump(minilm_embeddings_matrix, open('/Users/anastasiakaravdina/code/podcasts-recommender-system/models//Users/anastasiakaravdina/code/podcasts-recommender-system', 'wb'))