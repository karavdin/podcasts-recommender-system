...
def data_loading():
    df_podcasts = pd.read_csv('/Users/anastasiakaravdina/code/podcasts-recommender-system/data/processed/podcasts.csv')
    df_podcasts_top_10 = pd.read_csv('/Users/anastasiakaravdina/code/podcasts-recommender-system/data/processed/Top_10_podcasts.csv')
    tfidf_embeddings_matrix = scipy.sparse.load_npz('/Users/anastasiakaravdina/code/podcasts-recommender-system/models/tfidf_embeddings_matrix.npz')
    similarity_matrix = pickle.load(open('/Users/anastasiakaravdina/code/podcasts-recommender-system/models/similarity_matrix.pkl', 'rb'))
    ...
    minilm_embeddings_matrix = pickle.load(open('/Users/anastasiakaravdina/code/podcasts-recommender-system/models/minilm_embeddings_matrix.pkl', 'rb'))
